...
use HtmlSanitizer\Extension\Iframe\Node\EmbedNode;
 ...
 * @final
 */
class EmbedNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        $node = new EmbedNode($cursor->node);
