...
class FormExtension implements ExtensionInterface
{
    ...
    public function createNodeVisitors(array $config = []): array
    {
        return [
            ...
            'legend' => new NodeVisitor\LabelNodeVisitor($config['tags']['legend'] ?? []),
            'label' => new NodeVisitor\LabelNodeVisitor($config['tags']['label'] ?? []),
            'input' => new NodeVisitor\InputNodeVisitor($config['tags']['input'] ?? []),
            'option' => new NodeVisitor\InputNodeVisitor($config['tags']['option'] ?? []),
            'optgroup' => new NodeVisitor\InputNodeVisitor($config['tags']['optgroup'] ?? []),
